"""
Django settings for faq_module_qa_dev_51616 project.
...
ROOT_URLCONF = 'faq_module_qa_dev_51616.urls'
...
WSGI_APPLICATION = 'faq_module_qa_dev_51616.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "faq_module_qa_dev_51616 API",
    "DESCRIPTION": "API documentation for faq_module_qa_dev_51616 App",
    "VERSION": "v1",
}
