...
## Project Structure
    ...
    ├── faq_module_qa_dev_51616  # Django project configurations
...
1. Clone this repo and `cd faq_module_qa_dev_51616`
...
2. Clone this repo and `cd faq_module_qa_dev_51616`
